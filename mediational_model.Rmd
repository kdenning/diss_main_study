...
# mod2 <- aov(itt_comp_gmc ~ analog_condition, data = mod2_data) # Aov stats, does not matter that I used lm in mediation bc the same; probably easier for code
# summary(mod2)
...
*In "stereo_analyses" document. Examines threat composite predicting projection/counter-projection.*
