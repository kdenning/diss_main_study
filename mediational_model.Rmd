...
*Checked in "Descriptives and Demographics" file. For predictiors, it is normal enough since MLMs are robust to violations. The only variables not normal are the political orientation measures, which are not confirmatory predictors and will be transformed if used.*

## Multicolinearity

### Correlation matrix for predictors for MLMs
