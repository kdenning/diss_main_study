...
mod_model1_bfi <- lmer(bfi_targ ~ bfi_self_c + 
                     (1 | sub_id), 
...
mod_model1_eli <- lmer(eli_targ ~ eli_self_c + # itt does not work as a RE; model does not converge
                     (eli_self_c | sub_id), 
                   data = mod_1_data_eli) # Same as above, works with clean_data but not the smaller df specific to this analysis

tab_model(mod_model1_eli,
          digits = 3)
```
