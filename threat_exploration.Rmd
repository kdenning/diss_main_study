...
```{r}
bfi_1c <- lmer(bfi_targ_pmc ~ bfi_self_pmc*target_condition + 
                     (0 + bfi_self_pmc | sub_id), 
                   data = data_bfi) 
...
This is *Model 1b* in other_pre_reg_analyses.Rmd

## Target condition predicting composite

This is pilot_replication.Rmd 
